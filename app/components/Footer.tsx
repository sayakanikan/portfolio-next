            ...
            <div className="md:flex-1 grid grid-cols-1 mx-4 gap-8 sm:gap-6 sm:grid-cols-3">
              <div className="flex flex-col gap-5">
                <a href="#" className="flex items-center">
                  <span className="self-center text-3xl font-semibold whitespace-nowrap text-slate-800">Portfo<span className="text-indigo-500">lio</span></span>
                </a>
              ...
              <div>
                ...
                <ul className="text-gray-500 font-medium">
                  ...
                  <li className="mb-1">
                    <a href="https://www.prisma.io/" className="hover:text-indigo-500">
                      Prisma
                    </a>
                  </li>
                  <li className="mb-1">
