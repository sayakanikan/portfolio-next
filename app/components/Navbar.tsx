      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-5 md:mx-7 lg:mx-10 xl:mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg bg-transparent md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
            <li>
              <a href="#" className={`font-medium transition-all duration-300 block py-2 px-3 text-gray-900 md:hover:text-indigo-500 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 `} aria-current="page">
                Beranda
              </a>
            </li>
            <li>
              <a href="#" className={`font-medium transition-all duration-300 block py-2 px-3 text-gray-900 md:hover:text-indigo-500 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 `}>
                Pengalaman
              </a>
            </li>
            <li>
